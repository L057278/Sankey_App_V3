tabItem(tabName = "help",
              box(markdown("**App deployed here**: [![app]] add links
                            **Code can be found here**: [![repo] add links]"),
                width = 12),
              box(h2('Input Data (csv, sas7bdat or xlsx file)'),
                  ...
                  h3('Optional Columns'),
                  HTML('<p>
                          <b>PATHNAME</b>:  An encoding for the names of each path (e.g. for PATHNO 1, PATHNAME is DAY1 - DAY2). Preferable format is of "{start_timepoint} - {end_timepoint}" for additional functionality. Make sure PATHNAME is correctly mapped to PATHNO.
<br>
